...
class Base(object):
    ...
    #: Price excluding tax included discount
    excl_tax_incl_discount = None

    #: Price including tax
    incl_tax = None

    #: Price excluding tax included discount
    incl_tax_incl_discount = None
...
class FixedPrice(Base):
    ...
    def __init__(self, currency, excl_tax, excl_tax_incl_discount, tax=None):
        self.currency = currency
        self.excl_tax = excl_tax
        self.excl_tax_incl_discount = excl_tax_incl_discount
        self.tax = tax
    ...
    @property
    def incl_tax_incl_discount(self):
        if self.is_tax_known:
            return self.excl_tax_incl_discount + self.tax
        raise prices.TaxNotKnown(
            "Can't calculate price.incl_tax as tax isn't known")
...
class TaxInclusiveFixedPrice(FixedPrice):
    ...
    def __init__(self, currency, excl_tax, excl_tax_incl_discount, tax):
        self.currency = currency
        self.excl_tax = excl_tax
        self.excl_tax_incl_discount = excl_tax_incl_discount
        self.tax = tax
