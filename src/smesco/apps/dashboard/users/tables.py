...
from django_tables2 import A, Column, LinkColumn, TemplateColumn, CheckBoxColumn
...
class UserTable(DashboardTable):
    ...
    phone = Column(accessor='phone', verbose_name=_('Nomor Telphone'))
    birthdate = Column(accessor='birthdate', verbose_name=_('Tanggal Lahir'))
