...
class CustomerApplication(Application):
    ...
    address_new_delete_view = get_class('customer.views', 'AddressNewDeleteView')
    ...
    def get_urls(self):
        urlpatterns = [
            ...
            url(r'^addresses/(?P<pk>\d+)/$',
                ...
                name='address-detail'),
            url(r'^addresses/(?P<pk>\d+)/update/$',
                login_required(update_address),
                name='address-update'),
            url(r'^addresses/(?P<pk>\d+)/delete/$',
                login_required(self.address_delete_view.as_view()),
                name='address-delete'),
            url(r'^addresses/(?P<pk>\d+)/'
                r'(?P<action>default_for_(billing|shipping|shipping_address))/$',
                login_required(self.address_change_status_view.as_view()),
                name='address-change-status'),
            url(r'^addresses/(?P<pk>\d+)/new-delete/$',
                login_required(self.address_new_delete_view.as_view()),
                name='address-new-delete'),
